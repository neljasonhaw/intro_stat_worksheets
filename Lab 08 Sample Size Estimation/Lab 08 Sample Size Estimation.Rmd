---
title: "HSCI 50 LAB 8: Sample Size Estimation ANSWER KEY"
output: pdf_document
header-includes:
...
$$ \mathrm{FPC} \ \  n'= \frac{2377}{1 + 2377/10000} = 1920.5 = 1921$$
...
$$\mathrm{odds_{younger}} = \frac{p_{\mathrm{younger}}}{1 - p_{\mathrm{younger}}} = \frac{0.52}{1-0.52} = 1.0833$$
$$\mathrm{odds_{older}} = \mathrm{odds_{younger}} \times \mathrm{odds \ ratio}_{\mathrm{younger \ vs. \ older}} = 1.0833 \times 0.9 = 0.975$$
$$p_{\mathrm{older}} = \frac{\mathrm{odds_{older}}}{1+\mathrm{odds_{older}}} = \frac{0.975}{1+0.975} = 0.494$$
...
```{r checkwork, include = FALSE}
power.prop.test(p1 = .52, p2 = .37, power = .80)
power.prop.test(p1 = .52, p2 = .494, power = .80)
```
...
Plugging in the values we get:
$$\mathrm{odds \ ratio} = \frac{\frac{0.37}{0.63}}{\frac{0.52}{0.48}} = 0.54 $$
